...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include demo_mco_server"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/demo_mco_server/master/files/bootme.ps1')) -ArgumentList ("demo_mco_server")
#</powershell>


  param(
    [string]$role = "demo_mco_server",
  )

  $puppet_source = "https://github.com/pgomersbach/demo-mco-server.git"
